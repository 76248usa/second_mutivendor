...
class VendorProductController extends Controller
{
    ...
    public function VendorEditProduct(Request $request, $id){
        $id = $request->id;
        ...
        return view('vendor.backend.product.vendor_product_edit', compact('brands','categories',
    ...
    public function VendorUpdateProduct(Request $request){
         ...
         $notification = array(
            'message' => 'Vendor Product Updated Without Image',
            'alert-type' => 'success'
        );
