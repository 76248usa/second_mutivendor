			...
			<div class="row mb-3">
				...
				<div class="col-sm-9 text-secondary">
					{{-- <input type="file" class="form-control"  id="image"   /> --}}
					 <img id="showImage" src="{{ (!empty($inactiveVendorDetails->photo)) ? 
                     url('upload/vendor_images/'.$inactiveVendorDetails->photo):url('upload/no_image.jpg') }}" 
