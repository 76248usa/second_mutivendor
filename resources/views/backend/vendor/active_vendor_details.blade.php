...
<div class="col-lg-12">
	<div class="card">
		...
		<form method="post" action="{{ route('deactivate.vendor.approve') }}" enctype="multipart/form-data" >
			@csrf
			...
			<div class="row mb-3">
				...
				<div class="col-sm-9 text-secondary">
					<div class="col-sm-9 text-secondary">
						<textarea placeholder="Vendor Information" name="vendor_short_info"  class="form-control" id="inputAddress"  rows="3">
			...
			<div class="row mb-3">
				...
				<div class="col-sm-9 text-secondary">
					{{-- <input type="file" class="form-control"  id="image"   /> --}}
					 <img id="showImage" src="{{ (!empty($activeVendorDetails->photo)) ? 
                     url('upload/vendor_images/'.$activeVendorDetails->photo):url('upload/no_image.jpg') }}" 
