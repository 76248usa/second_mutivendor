                ...
                <div class="row">
                    ...
                    <form method="POST" action="{{ route('vendor.register') }}">
                        ...
                        <div class="form-group">
                            <input id="name" type="text" required="" name="name" placeholder="Store Name" />
                        </div>
                         <div class="form-group">
                            <input id="name" type="text" required="" name="username" placeholder="Username" />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <option selected="">Join Date - required</option>
