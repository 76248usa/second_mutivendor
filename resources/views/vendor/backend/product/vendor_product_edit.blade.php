...
<form id="myForm" method="post" action="{{ route('vendor.update.product', $product->id) }}" enctype="multipart/form-data" >
			@csrf
...
{{-- MAIN IMAGE --}}
    <div class="page-content">
        ...
        <hr/>
<div class="card">
    <form method="post" action="{{ route('vendor.update.thumbnail') }}" enctype="multipart/form-data" >
...
{{-- MULTI IMAGES --}}
 <div class="page-content">
        <h6 class="mb-0  text-uppercase">Update Multi Image Thumbnail</h6>
        <hr/>
<div class="card">
            <div class="card-body">
         ...
         <form method="post" action="{{ route('vendor.update.multiimage') }}" enctype="multipart/form-data" >
			@csrf
