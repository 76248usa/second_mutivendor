					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-itaem active" aria-current="page">Add Vendor Product</li>
							</ol>
						</nav>
					</div>
...
<form method="post" action="{{ route('vendor.store.product') }}" enctype="multipart/form-data"
        id="myForm" >
			@csrf
