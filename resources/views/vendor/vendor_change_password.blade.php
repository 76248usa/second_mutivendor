    ...
    @endif
			<div class="row mb-3"> 
				...
				<div class="col-sm-9 text-secondary">
					...
					<input type="password" name="old_password" class="form-control @error('old-password') is-invalid @enderror" 
            ...
            <div class="row mb-3"> 
				...
				<div class="col-sm-9 text-secondary">
                    ...
                    class="form-control @error('new_password') is_invalid @enderror" 
