    ...
    <div class="row">
        ...
        <form method="post">
            ...
            <div class="row">
                ...
                <div class="form-group col-lg-6">
                    <input type="email" required="" name="shipping_email" value={{ Auth::user()->email }} p>
                </div>
            </div>
            ...
            <div class="form-group col-lg-6">
                <input required="" type="text" name="post_code" placeholder="Area Zip Code">
            </div>
        </div>
                ...
                <div class="form-group col-lg-6">
                    ...
                    value="{{ Auth::user()->address }}" placeholder="Address">
                            ...
                            <div class="form-group mb-30">
                                <textarea rows="5" placeholder="Additional information" name="notes"
                                ></textarea>
                            </div>
  								...
  								$.ajax({
  										...
  										success:function(data){
  												...
  												$.each(data, function(key, value){
                                                        ...
                                                        append('<option value="'+ value.id + '">' + value.district_name + '</option>');
  												});
  										},
  								});
  						} else {
