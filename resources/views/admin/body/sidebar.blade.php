			...
			<ul class="metismenu" id="menu">
				...
				<li>
					<a href="javascript:;" class="has-arrow">
						...
						<div class="menu-title">Manage Banners</div>
					</a>
					<ul>
				...
				<li>
					...
					<ul>
							<li> 
								<a href="{{ route('all.division') }}"><i class="bx bx-right-arrow-alt"></i>All States</a>
						</li>
						<li> 
							
							 <a href="{{ route('all.district') }}"><i class="bx bx-right-arrow-alt"></i>All Cities</a>
						</li>

						<li> <a href="{{ route('all.state') }}"><i class="bx bx-right-arrow-alt"></i>Zip Codes</a>
						</li>
